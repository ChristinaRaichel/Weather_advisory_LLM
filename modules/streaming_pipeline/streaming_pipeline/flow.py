...
from streaming_pipeline.Accuweather_batch import AccuweatherBatchInput
from streaming_pipeline.Accuweather_stream import AccuweatherStreamInput
...
def build(
    ...
    """
    Builds a dataflow pipeline for processing weather inputs.
    ...
    Returns:
        Dataflow: The dataflow pipeline for processing weather inputs.
    """
...
def _build_input(
    ...
    if is_batch:
        ...
        return AccuweatherBatchInput(
            from_datetime=from_datetime, to_datetime=to_datetime, tickers=["*"]
        )
    else:
        return AccuweatherStreamInput(tickers=["*"])
